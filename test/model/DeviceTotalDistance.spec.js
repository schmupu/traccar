...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Traccar.DeviceTotalDistance();
  });
  ...
  describe('DeviceTotalDistance', function() {
    it('should create an instance of DeviceTotalDistance', function() {
      // uncomment below and update the code to test DeviceTotalDistance
      //var instane = new Traccar.DeviceTotalDistance();
      //expect(instance).to.be.a(Traccar.DeviceTotalDistance);
    });
